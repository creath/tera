...
const string strMessageMagic = "TeraCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees, int nHeight)
{
    ...
    int halvings = nHeight / 6517858;
    if (halvings >= 64)
        return nFees;
		
	if (nHeight == 1)
		return 102308750000 * COIN;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("TeraCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TeraCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // TeraCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TeraCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "TERA GENESIS";
        CTransaction txNew;
        txNew.nTime = 1477238812;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1477238812;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2650315; // !fTestNet ? 1575379 : 46534;
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9d83b2981d5b51e55701712f7e6ae31566c92eb181e53286a071ec81696e919e"));
...
unsigned char pchMessageStart[4] = { 0xb2, 0xfe, 0xe2, 0xe5 };
