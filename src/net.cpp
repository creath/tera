...
static const char *strDNSSeed[][2] = {
    {"seed1.cryptolife.net", "seed4.cryptolife.net"},
	{"seed2.cryptolife.net", "seed2.cryptolife.net"},
	{"seed3.cryptolife.net", "seed3.cryptolife.net"},
	{"electrum1.cryptolife.net", "electrum4.cryptolife.net"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TeraCoin is probably already running."), addrBind.ToString().c_str());
        else
